# Manufacturing — черновики (tips)

Сюда можно помещать временные заметки, разбор полей и варианты формулировок **до** переноса в канон [`crm-manufacturing-dictionaries.json`](../crm-manufacturing-dictionaries.json).
